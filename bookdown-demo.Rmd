...
<!--chapter:end:01-E_Einfuehrung.Rmd-->
...
<!--chapter:end:02-E_Grundlagen.Rmd-->
...
3. Sie möchten nun ihre letzte Rechnung als Objekte 'x' abspeichern. Wie könnten Sie das in der Konsole tun, ohen dass Sie nochmals den Kode der Rechnung ("(5 + 3 - 4) / 5") selber schreiben müssten? Und wo taucht nun 'x' auf?
